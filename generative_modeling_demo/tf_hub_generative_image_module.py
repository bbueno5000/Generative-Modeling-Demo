...
def find_closest_latent_vector(initial_vector, num_optimization_steps, steps_per_image):
    ...
    for step in range(num_optimization_steps):
        ...
        with tf.GradientTape() as tape:
            ...
            # The latent vectors were sampled from a normal distribution.
            # We can get more realistic images if we regularize the length
            # of the latent vector to the average length of vector from this distribution.
...
images, loss = find_closest_latent_vector(
    initial_vector, num_optimization_steps, steps_per_image)
